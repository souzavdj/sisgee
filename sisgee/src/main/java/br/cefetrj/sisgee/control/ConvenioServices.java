...
public class ConvenioServices {
    ...
    /**
     * Serviço que busca um Convenio com um CNPJ ou CPF do conveniado especifico
     * no banco de dados
     *
     * @param cnpj_cpf Representa o CNPJ ou CPF do conveniado.
     * @return Um unico Convenio com o CNPJ ou CPF utilizado como parametro.Caso
     * não exista retorna um null.
     */
