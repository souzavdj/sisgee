...
public class TermoAditivoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Valor: "+valorBolsa);
        ...
        if(vigencia == null && endereco == null && carga == null && professor == null && valorBolsa == null) {
            System.out.println("Entrei aqui");
            msg = "Por favor, selecione um motivo para o cadastro do termo aditivo";
            isValid = false;
        }
        ...
        if (termoEstagio != null) {
            ...
            request.setAttribute("termoEstagioAditivo", termoEstagio);
