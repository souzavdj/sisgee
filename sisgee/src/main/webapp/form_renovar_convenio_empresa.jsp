<%-- 
    Document   : form_renovar_convenio_empresa
    Created on : 02/06/2018, 02:06:21
    Author     : denis
--%>
            ...
            <form action=ValidarCadastroConvenioServlet method="post" name="validarConvenio">
                <fieldset class="form-group">
                        ...
                        <div class="custom-controls-stacked" >
                            <div class="form-inline">
                                <label class="custom-control custom-radio"> 
                                    <input id="empresaSim" name="tipo" type="radio" class="custom-control-input" value = "true"  ${ not empty tipoMsg ? '' : param.tipo == 'true' ? 'checked' : '' } > 
                                    <span class="custom-control-indicator"></span> 
                                    <span class="custom-control-description" ><fmt:message key = "br.cefetrj.sisgee.form_empresa.msg_PJ"/></span>
                                </label> 
                                <label class="custom-control custom-radio"> 
                                    <input id="empresaNao" name="tipo" type="radio" class="custom-control-input" value = "false" disabled="disabled"${ not empty tipoMsg ? '' : param.tipo == 'false' ? 'checked' : '' } > 
                                    <span class="custom-control-indicator"></span> 
                    ...
                    <div class="form-row">
                        <div class="form-inline" >
                            ...
                            <div class="custom-controls-stacked" >
                                <div class="form-inline">
                                    <label class="custom-control custom-radio"> 
                                        <input id="isAgente" name="agente" type="radio" class="custom-control-input" value = "true" readonly="true" > 
                                        <span class="custom-control-indicator"></span> 
                                        <span class="custom-control-description" ><fmt:message key = "br.cefetrj.sisgee.form_empresa.msg_sim"/></span>
                                    </label> 
                                    <label class="custom-control custom-radio"> 
                                        <input id="isAgente" name="agente" type="radio" class="custom-control-input" value = "false"> 
                                        <span class="custom-control-indicator"></span> 
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="cnpj" name="cnpj" maxlength="14" value="${param.cnpj}">                           
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="razaoSocial" name="razaoSocial" maxlength="100" value="${param.razaoSocial }">
                    </div>
