    ...
    <body>
        ...
        <div class="container">
            ...
            <c:if test="${not empty relatorio}">
                <div align='center'>
                    <button type="button" class="btn btn-primary" onclick="javascript:window.open('ImprimirRelatorioConsolidadoServlet?dataInicio=${param.dataDeInicio}&dataTermino=${param.dataDeTermino}&estagioObrig=${estagioObrig}&estagioNaoObrig=${estagioNaoObrig}&Locale=${Locale}')"><fmt:message key = "br.cefetrj.sisgee.relatorio.relatorio_consolidado.bt_imprimir"/></button>
                </div>
            </c:if>
        </div>
